...
if(turtlebot_obstacle_avoidance_CONFIG_INCLUDED)
  return()
endif()
set(turtlebot_obstacle_avoidance_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(turtlebot_obstacle_avoidance_SOURCE_PREFIX /home/zaina/catkin_ws/src/turtlebot_obstacle_avoidance)
  set(turtlebot_obstacle_avoidance_DEVEL_PREFIX /home/zaina/catkin_ws/devel_isolated/turtlebot_obstacle_avoidance)
  set(turtlebot_obstacle_avoidance_INSTALL_PREFIX "")
  set(turtlebot_obstacle_avoidance_PREFIX ${turtlebot_obstacle_avoidance_DEVEL_PREFIX})
else()
  set(turtlebot_obstacle_avoidance_SOURCE_PREFIX "")
  set(turtlebot_obstacle_avoidance_DEVEL_PREFIX "")
  set(turtlebot_obstacle_avoidance_INSTALL_PREFIX /home/zaina/catkin_ws/install_isolated)
  set(turtlebot_obstacle_avoidance_PREFIX ${turtlebot_obstacle_avoidance_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'turtlebot_obstacle_avoidance' is deprecated")
...
set(turtlebot_obstacle_avoidance_FOUND_CATKIN_PROJECT TRUE)

if(NOT " " STREQUAL " ")
  set(turtlebot_obstacle_avoidance_INCLUDE_DIRS "")
  set(_include_dirs "")
  if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'zaina <zaina@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${turtlebot_obstacle_avoidance_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'turtlebot_obstacle_avoidance' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'turtlebot_obstacle_avoidance' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zaina/catkin_ws/src/turtlebot_obstacle_avoidance/${idir}'.  ${_report}")
    endif()
    _list_append_unique(turtlebot_obstacle_avoidance_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND turtlebot_obstacle_avoidance_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND turtlebot_obstacle_avoidance_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT turtlebot_obstacle_avoidance_NUM_DUMMY_TARGETS)
      set(turtlebot_obstacle_avoidance_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::turtlebot_obstacle_avoidance::wrapped-linker-option${turtlebot_obstacle_avoidance_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR turtlebot_obstacle_avoidance_NUM_DUMMY_TARGETS "${turtlebot_obstacle_avoidance_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::turtlebot_obstacle_avoidance::wrapped-linker-option${turtlebot_obstacle_avoidance_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND turtlebot_obstacle_avoidance_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(turtlebot_obstacle_avoidance_LIBRARY_DIRS ${lib_path})
      list(APPEND turtlebot_obstacle_avoidance_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'turtlebot_obstacle_avoidance'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND turtlebot_obstacle_avoidance_LIBRARIES ${lib})
    endif()
  endif()
...
set(turtlebot_obstacle_avoidance_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${turtlebot_obstacle_avoidance_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 turtlebot_obstacle_avoidance_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${turtlebot_obstacle_avoidance_dep}_FOUND)
      find_package(${turtlebot_obstacle_avoidance_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${turtlebot_obstacle_avoidance_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(turtlebot_obstacle_avoidance_INCLUDE_DIRS ${${turtlebot_obstacle_avoidance_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(turtlebot_obstacle_avoidance_LIBRARIES ${turtlebot_obstacle_avoidance_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${turtlebot_obstacle_avoidance_dep}_LIBRARIES})
  _list_append_deduplicate(turtlebot_obstacle_avoidance_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(turtlebot_obstacle_avoidance_LIBRARIES ${turtlebot_obstacle_avoidance_LIBRARIES})

  _list_append_unique(turtlebot_obstacle_avoidance_LIBRARY_DIRS ${${turtlebot_obstacle_avoidance_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(turtlebot_obstacle_avoidance_EXPORTED_TARGETS ${${turtlebot_obstacle_avoidance_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${turtlebot_obstacle_avoidance_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
